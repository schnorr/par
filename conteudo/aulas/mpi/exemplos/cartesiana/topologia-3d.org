...
#+begin_src R :results file output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 600 :height 400 :session *R*
df |>
  filter(z == 0) |>
  rowwise() |>
...
#+RESULTS:
[[file:/tmp/babel-JjoHxz/figure4zIzIx.png]]
